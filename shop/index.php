...
?>
    ...
    <!-- Shipping Banner 시작 { -->
    <div id="sync2" class="fullWidth">
        <div style="text-align:center;">
            <a href="<?php echo G5_SHOP_URL; ?>/event.php?ev_id=1450682888"><img src="<?php echo G5_SHOP_SKIN_URL ?>/img/1224_banner_index.png" border="0" width="1110" alt="지금 보고스에서는 에디터 선정 상품 15% 할인 중!" title="지금 보고스에서는 에디터 선정 상품 15% 할인 중!"></a>
        </div>
        <div style="text-align:center;">
...
$(function() {
    ...
    <div class="fullWidth">
        ...
        <?php
        $order_by = 'it_order_newarrivals asc';
        $list = new item_list();
        $list->set_type(3);
