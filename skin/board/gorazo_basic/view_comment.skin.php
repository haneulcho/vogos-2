...
<!-- 댓글 시작 { -->
<div id="bo_vc" class="cmt_wrap" <? if($view['wr_comment'] == 0){?>style="display:none"<?}?>>
    <div class="cmt_top">
...
<aside id="bo_vc_w" class="cmt_wrap">
    ...
    <div class="tbl_wrap dno">
        <?php if ($is_guest) { ?>
        <div class="row">
            <label for="wr_name" style="display:inline-block;width:45px;">이름</label>
        ...
        <div class="row">
            <label for="wr_password" style="display:inline-block;width:45px;">비밀번호</label>
	...
	<div class="cmt_bot">
		<label><textarea id="wr_content" name="wr_content" maxlength="10000" required class="required" title="내용" onfocus="$('.tbl_wrap').removeClass('dno');"
