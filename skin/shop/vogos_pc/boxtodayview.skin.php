...
<aside id="stv">
    <div id="stv_list">
        <h2><i class="ion-ios-eye"></i><br>Recently<br>Viewed Items</h2>
        ...
        for ($i=1;$i<=$tv_idx;$i++)
        {
            ...
            $img = get_it_image2($tv_it_id, 2, $tv_div['img_width'], $tv_div['img_height'], $tv_it_id, '', $it_name);
        ...
        $(function() {
            ...
            if (itemQty > itemShow)
            {
                $('#stv_btn').append('<button type="button" id="up"><i class="ion-ios-arrow-back"></i></button><button type="button" id="down"><i class="ion-ios-arrow-forward"></i></button>');
            }
            var Flag = 1; // 페이지
