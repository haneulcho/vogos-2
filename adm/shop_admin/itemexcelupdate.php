...
if($_FILES['excelfile']['tmp_name']) {
    ...
    */
    ...
    for ($i = 3; $i <= $data->sheets[0]['numRows']; $i++) {
        ...
        $it_name_kr         = addslashes($data->sheets[0]['cells'][$i][$j++]);
        $it_name_en         = addslashes($data->sheets[0]['cells'][$i][$j++]);
        ...
        $it_basic_kr        = addslashes($data->sheets[0]['cells'][$i][$j++]);
        $it_basic_en        = addslashes($data->sheets[0]['cells'][$i][$j++]);
        $it_explan          = addslashes($data->sheets[0]['cells'][$i][$j++]);
        $it_price_kr        = addslashes($data->sheets[0]['cells'][$i][$j++]);
        $it_price_en        = addslashes($data->sheets[0]['cells'][$i][$j++]);
