...
<!-- 스크립트, 쿠키, 세션 사용 불가 -->
<input type="hidden" name="statusurl" value="<?php echo G5_MSHOP_URL.'/eximbay/status.php'; ?>" />
...
<input type="hidden" name="returnurl" value="<?php echo G5_MSHOP_URL.'/eximbay/return.php'; ?>" /><!--결제 완료 시 Front-end 방식으로 사용자 브라우저 상에 호출되어 보여질 가맹점 페이지 -->
...
<input type="hidden" name="ostype" value="M" /><!-- P: PC 버전(기본값), M : Mobile 버전-->
